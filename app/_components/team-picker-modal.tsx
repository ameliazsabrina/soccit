    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          <button
            onClick={() => onSelect(1)}
            className="group relative flex flex-col items-center gap-4 border border-surface bg-background p-8 transition-all hover:border-purple hover:shadow-[0_0_30px_rgba(139,92,246,0.3)] focus-visible:ring-2 focus-visible:ring-purple focus-visible:ring-offset-2"
          >
          ...
          <button
            onClick={() => onSelect(2)}
            className="group relative flex flex-col items-center gap-4 border border-surface bg-background p-8 transition-all hover:border-cyan hover:shadow-[0_0_30px_rgba(6,182,212,0.3)] focus-visible:ring-2 focus-visible:ring-cyan focus-visible:ring-offset-2"
          >
